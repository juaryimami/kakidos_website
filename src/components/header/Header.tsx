    ...
    <div className="w-11/12 mx-auto">
      ...
      <div className="flex justify-center items-center h-16">
        <div className="w-5/12 h-full">
          <div className="bg-transparent p-8 md:p-16  lg:pl-20 lg:pt-20 max-w-lg mx-auto flex flex-col items-center justify-center text-center" style={{backgroundImage: `url(${pattern})`, backgroundSize: 'cover',backgroundPosition: 'center', backgroundRepeat: 'no-repeat',}}>
            {/* Heading */}
        ...
        <div className="bg-white w-5/12 h-full bg-transparent">
          <div className="bg-white p-8 md:p-16 pb-0 lg:pl-20 lg:pt-20 max-w-lg flex flex-col items-center justify-center text-center" style={{backgroundImage: `url(${pattern})`, backgroundSize: 'cover',backgroundPosition: 'center', backgroundRepeat: 'no-repeat',}}>
