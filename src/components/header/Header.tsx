    ...
    <div className="lg:w-11/12 lg:mx-auto">
      ...
      <nav className="p-4 bg-[#182F49] sm:hidden flex justify-between items-center">
        <div className="text-xl font-bold">
          <img src={stackedlogo} alt="Top Image" className="w-24 h-24 object-cover" />
        </div>
        <button className="md:hidden w-24 h-24 text-white object-cover text-4xl">☰</button>
      </nav>
      ...
      <div className="max-sm:hidden flex justify-center items-center sm:h-16">
        ...
        <div className="max-sm:hidden bg-white w-5/12 h-full bg-transparent">
          <div className="max-sm:hidden bg-white p-8 md:p-16 pb-0 lg:pl-20 lg:pt-20 max-w-lg flex flex-col items-center justify-center text-center" style={{backgroundImage: `url(${pattern})`, backgroundSize: 'cover',backgroundPosition: 'center', backgroundRepeat: 'no-repeat',}}>
            <h2 className="text-[#E2426C] text-xl font-semibold mb-4">
              Our Courses
            </h2>
